...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://cdn.staticaly.com/gh/AlexChen68/OSS@master/images/1686762625238.png" alt="" width="400" height="500" loading="lazy"></p><ol start="7"><li>在主服务器增加数据，自动同步数据到从数据库相应数据库即设置成功（同步哪些数据库由上述的配置文件设定）</li></ol><h2 id="shardingsphere-实现读写分离" tabindex="-1"><a class="header-anchor" href="#shardingsphere-实现读写分离" aria-hidden="true">#</a> ShardingSphere 实现读写分离</h2><blockquote><p>TODO</p></blockquote>`,20),r=[i];function o(t,c){return a(),n("div",null,r)}const d=s(l,[["render",o],["__file","3.4-master-slave.html.vue"]]);export{d as default};
