...
本文介绍 Node.js 的模块化规范 - CommonJS 规范。
<!-- more -->

> 原文链接：[https://javascript.ruanyifeng.com/nodejs/module.html](https://javascript.ruanyifeng.com/nodejs/module.html)
...
`require`方法的详细解释参见《Require 命令》一节。
