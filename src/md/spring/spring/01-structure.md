...
![Spring模块](https://cdn.staticaly.com/gh/AlexChen68/images@master/blog/springframework-modules.png)

各个模块之间存在一些依赖关系如下：

![Spring模块依赖关系](https://cdn.staticaly.com/gh/AlexChen68/images@master/blog/springframework-modules-relation.png)
