...
![列举常用的容器类](https://cdn.staticaly.com/gh/AlexChen68/image-hosting@master/blog/java/并发容器.png)
...
![分段锁机制](https://cdn.staticaly.com/gh/AlexChen68/image-hosting@master/blog/java/分段锁机制.png)
