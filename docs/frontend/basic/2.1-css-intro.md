...
本文主要介绍 CSS 发展、CSS 模块化定义和 CSS 模块化的实现方式
<!-- more -->

> 原文链接：https://juejin.cn/post/6844904034281734151
...
**CSS 模块化和 CSS in jS 的对比**：

![CSS 模块化和 CSS in jS 的对比](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/12/30/16f5477372d2bee3~tplv-t2oaga2asx-zoom-in-crop-mark:3024:0:0:0.awebp)
